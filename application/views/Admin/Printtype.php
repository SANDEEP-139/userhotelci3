...
<div class="col-12 mb-4 mb-xl-0">
                                <div class="card redial-border-light redial-shadow mb-4">
                                    <div class="card-body">
                                                ...
                                                <form   method ="post"  id="Addprint" action="<?php  echo base_url();?>Product/printtype_management/<?php  echo $action;?>">
  <div class="row">
    <div class="col-md-6">
      <div class ="form-group">
        ...
        <input type="text" name="printtype_name"  onkeydown = "return Check(this,event)" value="<?php  echo $updaterecord['printtype_name'];?>" class="form-control" trim>
...
<tbody>
   ...
   foreach($record as $user){ ?>                  
     ...
     <td> <?php  echo $i;?></td>
     <td><?php  echo  $user['printtype_name']?></td>
<td>  <?php
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="status_<?php  echo $user['id']?>">&nbsp;</label>
            ...
            <td>
            <div class="btn-group">
               <a href="<?php  echo base_url().'Product/printlist/'.$user['id'];?>"> <i class="fa fa-edit"></i></a>
            </div>    
            <div class="btn-group">
               <a href="<?php  echo base_url().'Product/printtype_management/delete/'.$user['id'];?>"> <i class="fa fa-trash"></i>
            </div>
            </td>
        </tr>
		<?php $i++;} ?>
...
if(a==true){
 var cat_id = $(this).attr('cat_id_attr');
          ...
          if ($(this).is(":checked")) {
              $.ajax({
                  url: '<?php echo base_url();?>Product/getprintactive',
...
//return false;
 ...
 $("#Addprint").validate({
    ...
    rules: {
      printtype_name:"required",
     
    },
   messages:{
    printtype_name:"Please enter Print Type",
