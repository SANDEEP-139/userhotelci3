...
<div class="col-12 mb-4 mb-xl-0">
                                <div class="card redial-border-light redial-shadow mb-4">
                                    <div class="card-body">
                                                ...
                                                <form   method ="post"  id="Addcolor" action="<?php  echo base_url();?>Product/colortype_management/<?php  echo $action;?>">
  <div class="row">

    <div class="col-md-6">
      <div class ="form-group">
        <label for="color_type"><!-- Subcategory Name  -->Name<span class="validation-color" style="color: red;">*</span></label>
        <input type="hidden" name="id" value="<?php  echo $updaterecord['id'];?>">
        <input type="text" name="color_type"   onkeydown = "return Check(this,event)"value="<?php  echo $updaterecord['color_type'];?>" class="form-control">
...
<tbody>
   ...
   $i=1; 
    foreach($record as $user){ ?>                  
     ...
     <td> <?php  echo $i;?></td>
     <td><?php  echo  $user['color_type']?></td>
<td><?php
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="status_<?php  echo $user['id']?>">&nbsp;</label>
            ...
            <td>
            <div class="btn-group">
               <a href="<?php  echo base_url().'Product/colorlist/'.$user['id'];?>"> <i class="fa fa-edit"></i></a>
            </div>    
            <div class="btn-group">
               <a href="<?php  echo base_url().'Product/colortype_management/delete/'.$user['id'];?>"> <i class="fa fa-trash"></i>
            </div>
            </td>
        </tr>
		<?php $i++;} ?>
...
if(a==true){
 var cat_id = $(this).attr('cat_id_attr');
          ...
          if ($(this).is(":checked")) {
              $.ajax({
                  url: '<?php echo base_url();?>Product/getcoloractive',
