                            ...
                            <li id="dropzone" class="list-inline-item mr-3 redial-relative">
                                <div class="row">
                                    <div class="col-md-5 col-sm-5 col-xs-6">
                                        <a href="<?php echo base_url() . 'Product/updatecategory'; ?>" class="btn btn-primary btn-xs text-uppercase">Add category</a>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($record as $user) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <a href="<?php echo base_url() . 'Product/updatecategory/' . $user['id']; ?>"> <i class="fa fa-edit"></i></a>
                                                                </div>    
    ...
    $(document).ready(function () {
        ...
        $(".statuscheck").click(function () {
            ...
            if (a == true) {
                ...
                if ($(this).is(":checked")) {
                    $.ajax({
                        url: '<?php echo base_url(); ?>Product/getactive',
