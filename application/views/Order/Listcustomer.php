                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 col-sm-5 col-xs-6">
                                                    <a href="<?php  echo base_url().'Product/updatecustomer';?>" class="btn btn-primary btn-xs text-uppercase">Add customer</a>
                                                </div>
...
<td><?php  echo  $user['credit_period']?></td>
<td><?php  echo  $user['pan']?></td>
<td><?php  echo  $user['opening_balance']?></td>
<td><?php  echo  $user['contact_person_name']?></td>
...
<td>
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="status_<?php  echo $user['id']?>">&nbsp;</label>
             ...
             <td>
            <div class="btn-group">
               <a href="<?php  echo base_url().'Product/updatecustomer/'.$user['id'];?>"><i class="fa fa-edit"></i></a>
            </div>    
            <div class="btn-group">
              <a href="<?php  echo base_url().'Product/customer/delete/'.$user['id'];?>"><i class="fa fa-trash"></i></a>
            </div>
            </td>
            </tr><?php $i++;}?>                         
    </tbody>
...
if(a==true){
 var cat_id = $(this).attr('cat_id_attr');
          ...
          if ($(this).is(":checked")) {
              $.ajax({
                  url: '<?php echo base_url();?>Product/getactivecustomer',
